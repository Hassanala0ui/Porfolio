...
import { Download, Mail, ArrowRight, Award, Briefcase, Users } from 'lucide-react';
import { Button } from './ui/button';
import { Badge } from './ui/badge';
import HassanPhoto from 'figma:asset/me.jpg';
...
export function HeroSection() {
  ...
  const highlights = [
    ...
    { icon: Briefcase, text: '25+ Projects Delivered' },
    { icon: Users, text: '10M+ Users Impacted' }
  ];
          ...
          >
            ...
            >
              ...
              <div className="w-80 h-80 md:w-96 md:h-96 lg:w-[420px] lg:h-[420px] rounded-3xl overflow-hidden border-4 border-background shadow-2xl relative">
                <img
                  src={HassanPhoto}
                  alt="Hassan Alaoui Taibi - AI & ML Engineer"
